...
<script src="/scripts/questionBank/dailyPractice.js"></script>
<@b.body menu="sidebarmenu-questionBank"
submenu="sidebarmenu-questionBank-dailyPractice">
<div ng-controller="dailyPractice">
	...
	<div class="details">
		...
		<div class="details-frame">
			<div
				style="font-size: 1.6rem; font-weight: bold; padding-bottom: 10px;">{{courseTypeSubclassName}}</div>
			<ul id="guanli">
				<li style="background: white; box-shadow: none;" onclick="go(0)"><p>每日一练</p></li>
				<li onclick="go(1)"><p>每日一练管理</p></li>
			</ul>
			<!-- 管理 -->
			<div id="sectionmanage" class="manage" >
				<ul class="show">
				...
				<div class="poop" id="add">
					<form id="myform" class="ng-pristine ng-valid">
						<h3>{{courseTypeSubclassName}}</h3>
						<div class="select-2">
							<span>名称<i class="bitian">*</i></span> <input
								ng-model="questionSubCategory.name" type="text"
								class="ng-pristine ng-untouched ng-valid ng-empty"
								placeholder="请输入名称">
						</div>
						<div class="select-2">
							<span>考试时间(分钟)<i class="bitian">*</i></span> <input
								ng-model="questionSubCategory.times" type="text"
								class="ng-pristine ng-untouched ng-valid ng-empty"
								placeholder="">
						</div>
						...
						<div class="select-radio ">
							<ul>
								<li>是否可见</li>
								<li><input type="radio"
									ng-model="questionSubCategory.isshow" ng-value="1"
									class="ng-pristine ng-untouched ng-valid ng-empty" name="1">
									是</li>
								<li><input type="radio"
									ng-model="questionSubCategory.isshow" ng-value="0"
									class="ng-pristine ng-untouched ng-valid ng-empty" name="1">否</li>
							</ul>
						</div>
						<div class="end">
							<input name="git" type="submit" value="提交" ng-show="id==null"
								ng-click="questioncateadd()" style="background: #5ED8A9;">
							<input name="git" type="submit" value="修改" ng-show="id!=null"
								ng-click="updatesubCategory()" style="background: #5ED8A9;"
								class="ng-hide"> <input name="esc" type="reset"
			...
			<div id="manage" class="manage" style="display: none;">
				<ul class="show">
					...
					<li style="background: #9DE879;" ng-click="showrevise()"><span
						class="glyphicon glyphicon-plus"></span>&nbsp;从文件导入试题</li>
					<li style="background: #F9CD33;" ng-click="updatebank()"><span
						class="glyphicon glyphicon-pencil"></span>&nbsp;修改试题</li>
					<li style="background: #F86846;" ng-click="deletequestionbank()"><span
						class="glyphicon glyphicon-trash"></span>&nbsp;删除试题</li>

				</ul>
				<div
					style="clear: both; padding-top: 20px; padding-left: 20px; overflow: hidden;">
					<div class="classify">

						<ul style="width:100%;border: 1px #c7c6c6 solid;">

							<li ng-repeat="qbc in questionsubcatelist" class="list"
								ng-click="checkquestionsub(qbc)"
								ng-class="{'typeselected':selecteds==qbc.id}" style="text-align:center;font-size:1.5rem;padding:5px 0;">{{qbc.name}}</li>
							...
							<tbody>
								...
								<tr ng-repeat="qb in questionbanklist"
									...
									<th><ul style="margin: 0; padding: 0;">
											<li ng-repeat="qba in qb.answer"
												style="width: 100%; border-bottom: 1px solid #f6f6f6c4; line-height: 20px; clear: both; height: 20px;">
												<span style="float: left;">{{qba.options}}.{{qba.answers}}</span><span
												style="float: right;">{{qba.corrects}}</span>
											</li>
										</ul></th>
				...
				<div class="poop" id="revise">
					<form id="myform2" class="ng-pristine ng-valid">
						...
						<div class="end">
							<input name="git" type="submit" value="提交" ng-click="addfile()"
								style="background: #5ED8A9;"> <input name="esc"
								type="reset" value="取消" onclick="CloseDiv2()" class="esc">
						</div>
					</form>
				</div>
				<!-- 修改试题 -->
				<div id="resource" class="resource"
					style="width: 600px; min-width: 600px; left: 20%;">
					<form id="myform3" class="ng-pristine ng-valid">
						<h3 style="margin-bottom: 0;">修改试题</h3>
						<p style="border-bottom: 1px solid #999; padding-bottom: 5px;">
							<span>试题所属：{{subName}}</span><span style="margin-left: 10%;">试题类型：{{questionbanks.types}}</span>
						</p>
						<div>
							<div style="float: left; width: 49%;">
								<div class="grade-text">
									<span>试题标题</span>
									<textarea ng-model="questionbanks.title"
										class="ng-pristine ng-untouched ng-valid ng-empty"></textarea>
								</div>
								<div class="grade-text">
									<span>答案解析</span>
									<textarea ng-model="questionbanks.analysis"
										class="ng-pristine ng-untouched ng-valid ng-empty"></textarea>
								</div>
								<div class="select-2">
									<span>解析视频ID<i class="bitian">*</i></span> <input type="text"
										class="ng-pristine ng-untouched ng-valid ng-empty"
										placeholder="视频ID">
								</div>
								<div class="select-2">
									<span>试题考点ID<i class="bitian">*</i></span> <input type="text"
										class="ng-pristine ng-untouched ng-valid ng-empty"
										placeholder="考点ID">
								</div>
							</div>
							<div style="width: 49%; float: right;">
								...
								<div class="daan">
									<p style="margin: 10px 0px 0px 3px;">
										<span>答案项</span><span style="float: right; margin-right: 8px;">是否正确</span>
									</p>
									<table>
										<tbody>
											<tr ng-repeat="qbas in questionanswers">
												...
												<td>
													<div class="dw">
														<img src="/images/sjk-xl.png"> <select
															ng-change="changeCorrect(qbas)"
															class="ng-pristine ng-untouched ng-valid ng-empty"
															ng-model="qbas.correct">
						...
						<div class="end" style="margin-top: 10px;">
							...
							<input name="esc" type="reset" value="取消" ng-click="resetbank()"
								class="esc">
						</div>
					</form>
					...
					<form id="myform3" class="ng-pristine ng-valid">
						...
						<div>
							...
							<div style="width: 49%; float: right;">
								<div class="shiti">
									<ul>
										<li ng-repeat="qbul in questionunitlist"
											ng-class="{'typeselected':typeselected==qbul}"
											ng-click="checkshiti(qbul)">{{qbul.shiti}}</li>
								...
								<div class="grade-text">
									<span>答案解析</span>
									<textarea ng-model="questionunitlists.analysis"
										class="ng-pristine ng-untouched ng-valid ng-empty"></textarea>
								</div>
										...
										<tbody>
											<tr ng-repeat="qbual in questionunitanswerlist">
												...
												<td>
													<div class="dw">
														<img src="/images/sjk-xl.png"> <select
															ng-change="changeUnitCorrect(qbual)"
															class="ng-pristine ng-untouched ng-valid ng-empty"
															ng-model="qbual.correct">
