		...
		<div class="details-frame">
			...
			<div id="revise" class="resource" style="display: none;">
					...
					<div>
						...
						<ul style="width: 100%; height: 80px; margin: 15px 0;"
							...
							<div style="width: 75%; height: 100%; float: right;">
								...
								<p>
									<span style="color: #B1B1B1;">原价：{{p.productPrice}}</span>
								</p>
								<p>
									<span>现价：{{p.productPrice}}</span>
								</p>
							</div>
						</ul>
				...
				<div class="end" style="width: 100px;">
					<input name="esc" type="reset" value="关闭"
						onclick="CloseDiv2();formReset2()" class="esc">
				</div>
...
.details-frame-content .select-3 {
	width: 10%;
	margin-right: 1%;
}
...
.details-frame-content .select-3 input {
	border-radius: 0;
}
