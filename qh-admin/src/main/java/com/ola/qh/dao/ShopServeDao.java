...
public interface ShopServeDao {
	...
	public int selectShopServeCount(@Param("shopName")String shopName,@Param("serveName")String serveName,@Param("serveType")String serveType,
			@Param("serveStatus")String serveStatus);
