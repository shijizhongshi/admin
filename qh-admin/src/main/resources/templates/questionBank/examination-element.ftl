...
<script src="/scripts/questionBank/examination-element.js"></script>
...
<div class="details-frame">
	...
	<ul id="guanli">
	<li style="background:white;box-shadow:none;" onclick="go(0)" ><p>单元管理</p></li>
	<li onclick="go(1)" ><p>单元试题管理</p></li>
	</ul>
	<!-- 单元管理 -->
<div id="sectionmanage" class="manage" i>
	<ul class="show">

			<li style="background:#9DE879;" ng-click="add()"><span class="glyphicon glyphicon-plus" ></span>&nbsp;添加单元</li>
		<li style="background:#F9CD33;" ng-click="update()"><span class="glyphicon glyphicon-pencil"></span>&nbsp;修改单元</li>
		<li style="background:#F86846;" ng-click="deletequestion()"><span class="glyphicon glyphicon-trash"></span>&nbsp;删除单元</li>
...
<th>考试时间</th>
	...
	<h3>{{name}}</h3>
	<p style="padding:10px 0;">试卷名称：&nbsp;${name}</p>
<div class="select-2">
...
<div id="resource" class="resource" style="width:600px;min-width:600px;left:20%;">
	...
	<p style="border-bottom:1px solid #999;padding-bottom:5px;"><span>试题所属单元：{{subName}}</span><span style="margin-left:10%;">试题类型：{{questionbanks.types}}</span></p>
	<div>
