...
<html lang="en">
	...
	<@b.body menu="sidebarmenu-league" submenu="sidebarmenu-league-shangpin">
		<div>
							...
							<div class="admin-table">
								...
								<table>
									...
									<tr>
										...
										<th>店铺类型</th>
										<th>推荐级别</th>
										<th><img src="" name="店铺标志"/></th>
										<th><img src="" name="门头照片"/></th>
										<th>负责人</th>
										<th>联系电话</th>
										<th>创建时间</th>
  ...
  <div class="costs-img"> <img  src="" /></div></div>
  				<div class="costs-uploadfile-div">   
				许可证<input type="file" name="file"   accept="image/*"  value="上传课程图片" onchange="" /> 
   <input type="hidden" ng-model="" />
  <div class="costs-img"> <img  src="" /></div></div>
  				<div class="costs-uploadfile-div">   
