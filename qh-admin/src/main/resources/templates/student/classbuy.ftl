...
submenu="sidebarmenu-student-classbuy">
	...
	<div class="details" style="width: 100%">
		...
		<div class="details-frame">
			<div class="details-frame-content">
				<div class="select-3">
					<span>学员购买时间</span> <input type="date" name="search"
						ng-model="fromdate"
				...
				<div class="select-3">
					<span>学员姓名或电话</span> <input type="text" placeholder="请输入姓名或电话"
						ng-model="nicknameORmobile"
						class="ng-pristine ng-untouched ng-valid ng-empty">
				</div>
				<!--加一个根据学员班级查询  -->
				<div class="select-3">
					<span>学员班级</span> <input type="text" placeholder="请输入学员所在班级"
						ng-model="courseName"
						class="ng-pristine ng-untouched ng-valid ng-empty">
				</div>
				<!--<div class="select-3">
