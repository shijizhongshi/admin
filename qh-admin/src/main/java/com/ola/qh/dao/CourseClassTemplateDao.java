...
public interface CourseClassTemplateDao {
	...
	public List<CourseClassTemplate> selectCourseClassTemplate(@Param("templateName")String templateName,@Param("pageNo")int pageNo,@Param("pageSize")int pageSize);
	...
	public int deleteCourseClassTemplate(@Param("templateName")String templateName);
}
