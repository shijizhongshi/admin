...
.load-body{background: url(../images/load2.png) no-repeat;background-size:100%;width:60%;height: 80%;}
.load-body form{width: 50%;height: 80%;float: right;padding:15% 10%;margin-top:0.1rem;}
.load-body  input{width: 100%;height: 5%;border: 1px solid #B1B1B1;padding: 8%;margin-top:15px;font-size:0.2rem;line-height: 5%;}
</style>
 </html>
