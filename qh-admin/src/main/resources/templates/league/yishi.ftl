			...
			<div class="details" style="width: 100%">
				...
				<div class="details-frame">
					<div class="details-frame-content" id="details-frame-content">
						<ul>
							<li onmousedown="go(0)" style="border-bottom:3px solid red;font-weight: 900;">医师管理</li>
					...
					<input type="button" class="btn-lg im-key" ng-click=""
						value="检索" ng-click="" />
							...
							<ul style="height: 80px;" class="show">
								...
								<li onclick="showDiv()" style=" background: #9DE879;"><span class="glyphicon glyphicon-plus"></span>&nbsp;添加医师</li>
							...
							<div class="poop" id="add">
								...
								<div class=" select-2" style="clear:both;">
									<img src="/images/sjk-xl.png" /> <span>地区</span>
									 <select>
										<option disabled selected style='display: none;'></option>
										<option>山东</option>
										<option></option>
									...
									<div class="select-2">
										...
										<div class="select-2">
											<span>添加标签</span>
											<input type="text" placeholder="" style="border-radius:0;"/>
										<div style=" border:1px solid #B1B1B1;  position: absolute; right:0px; top: 31px;line-height:28px; display: inherit; cursor: pointer;height:28px;" >
										<i class="glyphicon glyphicon-plus" style="font-size: 1.0rem;"></i>&nbsp;添加</div></div>
										<div class="biaoqian">
										<ul><li><span>这里是标签 </span>&nbsp;<i class="glyphicon glyphicon-remove" ></i></li>
										<li><span>这里是标签 </span>&nbsp;<i class="glyphicon glyphicon-remove"></i></li></ul>
										</div>
...
<div class="costs-uploadfile-div">   
	<span style="float: left;">正面:&nbsp;</span><input type="file" name="file"   accept="image/*"  value="身份证正面" onchange="" /> 
   <input type="hidden" ng-model="" />
</div>
&nbsp;<div class="costs-uploadfile-div" >   
	<span style="float: left;">反面:&nbsp;</span><input type="file" name="file"   accept="image/*"  value="身份证反面" onchange="" /> 
   <input type="hidden" ng-model="" />
</div>
  				&nbsp;<div class="costs-uploadfile-div">   
				医师照片<input type="file" name="file"   accept="image/*"  value="上传课程图片" onchange="" /> 
   <input type="hidden" ng-model="" />
  <div class="costs-img"> <img  src="" /></div></div>
  				<div class="costs-uploadfile-div">   
				职称证明<input type="file" name="file"   value="上传课程图片" onchange="" /> 
   <input type="hidden" ng-model="" /><div class="costs-img"> <img  src="" /></div>
</div>
  				<div class="costs-uploadfile-div">   
   ...
   <input type="hidden" ng-model="" />
		...
		<ul><li>是否推荐</li>  
		<li><input type="radio" ng-model="" ng-value="1" class="ng-pristine ng-untouched ng-valid ng-empty" name="3" value="1"> 是</li> 
		<li><input type="radio" ng-model="" ng-value="0" class="ng-pristine ng-untouched ng-valid ng-empty" name="4" value="0">否</li></ul>
		</div>
									</div>
										</div>
								</form>
				...
				<div id="revise" class="resource">
								<form id="myform2">
									...
									<div class="template-add">
										<div class="grade-left" style="padding-right: 5%;">
                                       <div style="width:50%;margin: 0 auto;text-align: center;height: 130px">
				...
				<img  src=""style="width: 30%;float: left;height:70px;margin-right:3%;"/>
				...
				<img  src=""  style="width: 30%;float: left;height:50px;margin-right:3%;"/>
				<img  src=""   style="width: 30%;float: left;height:50px;margin-right:3%;""/>
				<img  src=""  style="width: 30%;float: left;height:50px;"/>
				<img  src="" style="width: 30%;float: left;height:50px;margin-top: 10px;"/>
				</div></div>
