...
<@b.body menu="sidebarmenu-questionBank" submenu="sidebarmenu-questionBank-questionJie">
<div>
<div class="classify" >
		<ul class="menu">
...
<div class="manage">
	<ul class="show">
			...
			<li style="background:#9DE879;" onclick="showDiv()"><span class="glyphicon glyphicon-plus" ></span>&nbsp;添加节</li>
		<li style="background:#F9CD33;"><span class="glyphicon glyphicon-pencil"></span>&nbsp;修改节</li>
		<li style="background:#F86846;"><span class="glyphicon glyphicon-trash"></span>&nbsp;删除节</li>
...
<th>试题数量</th>
	...
	<h3>{{}}节</h3>
	<p style="padding:10px 0;">章节名称：&nbsp;{名称}</p>
<div class="select-2">
		<span>节名称<i class="bitian">*</i></span>
<input type="text" class="ng-pristine ng-untouched ng-valid ng-empty" placeholder="请输入节名称" >
	</div>
	<div class="select-2">
