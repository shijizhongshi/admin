			...
			<div class="manage">
				<ul class="show">
					...
					<li ng-click="deleteClass()" style="background: #F86846;"><span
						...
						<li style="width: 90px;" ng-click="classmove(1)"><span class="glyphicon glyphicon-sort"></span>&nbsp;上移</li>
				<li style="width: 90px;" ng-click="classmove(2)"><span
		...
		<li ><span class="glyphicon glyphicon-briefcase"></span>&nbsp;关闭城市管理</li>-->
				...
				<div class="admin-table">
					...
					<table>
						...
						<tr ng-repeat="c in classlist" ng-click="checkedclass(c)"
							ng-class="{'selected':selected==c}">
							<th>{{c.className}}</th>

							<th><img ng-src="{{c.imgUrl}}"
							...
							<div class="grade-left" style="padding-right: 5%;">
								...
								<div class=" select-2" style="width: 100%;">
									<span>班级名称：</span> <input type="text"
										ng-model="classes.className" class="" placeholder="请输入班级名称" />
								</div>
								...
								<div style="width: 100%; height: 90px; clear: both;">
									<div class="select-2" style="float: left;">
										...
										<select ng-model="classes"
											ng-change="checkedTemplate(classes)"
											ng-options="classes as classes.templateName for classes in templatelist"
											ng-selected="selected==classes">
										</select>
										<!--<ul ng-show="tems==1">
			<li style="float:none;" ng-repeat="classes in templatelist" ng-click="checkedTemplate(classes)" ng-model="classes.templateId">{{classes.templateName}}</li>
									...
									<div class=" select-2" style="float: right;">
										<img src="/images/sjk-xl.png" /> <span>主讲老师：</span> <select
											ng-model="classes.courseLecturer"
											ng-options="t.name as t.name for t in teacherlist"
											ng-selected="selected==t.name">
										</select>
									</div>
								</div>
								<div style="width: 100%; height: 90px; clear: both;">
									<div class=" select-2" style="float: left;">
										...
										<span>班级价格：</span> <input ng-model="classes.classPrice"
											type="text" class="" placeholder="请输入班级名称" />
									</div>
									<div class=" select-2" style="float: right;">

										<span>班级折扣价：</span> <input type="text"
											ng-model="classes.classDiscountPrice" class=""
											placeholder="请输入班级名称" />
									</div>
								</div>
								...
								<div class=" select-2" style="width: 100%;">
									<span>最多折扣豆：</span> <input type="number"
										ng-model="classes.maxdoudou" class=""
										placeholder="请输入最多使用的豆豆数" />
								</div>
								<div style="width: 100%; height: 90px; clear: both;">
									...
									<div class=" select-2" style="float: left;">
										...
										<span>班级年份：</span> <input type="text"
											ng-model="classes.classYear" class="" placeholder="请输入班级年份" />
									</div>
									<div class=" select-2" style="float: right;">

										<span>总课课时数：</span> <input type="text"
											ng-model="classes.allTime" class="" placeholder="请输入课时数" />
									</div>
								</div>
								<!--<div class=" select-2">
				...
				<option></option>
								...
								<ul>
									...
									<li><input type="radio" name="tuijian"
										ng-model="classes.isremmend" ng-value="1" /> 是</li>
									<li><input type="radio" name="tuijian"
										ng-model="classes.isremmend" ng-value="0" />否</li>
								</ul>
								<!--<ul>
<li>是否关闭  </li>
...
<li><input type="radio" name="tuijian" />否</li>
								...
								<ul>
									<li>是否显示</li>
									<li><input type="radio" ng-model="classes.isshow"
										ng-value="1" /> 是</li>
									<li><input type="radio" ng-model="classes.isshow"
										ng-value="0" />否</li>
								</ul>
					...
					<div class="end">
						<input name="git" type="submit" ng-show="classId==null"
							ng-click="addClass()" value="提交" style="background: #5ED8A9;" />
						<input name="git" type="submit" ng-show="classId!=null"
							ng-click="addClass()" value="修改" style="background: #5ED8A9;" />
						<input name="esc" type="reset" value="取消" ng-click="rest()"
							class="esc" />
					</div>
				</div>
			</div>
