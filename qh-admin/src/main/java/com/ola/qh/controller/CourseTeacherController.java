...
public class CourseTeacherController {
	...
	public Results<List<CourseTeacher>> selectCourseSection(@RequestParam(name = "pageNo", required = true) int pageNo,
		...
		List<CourseTeacher> list = courseTeacherService.selectCourseTeacher(pageNo, pageSize, courseTypeName,
				courseTypeSubclassName, teacherName);

		results.setCount(
				courseTeacherService.selectCourseTeacherCount(courseTypeName, courseTypeSubclassName, teacherName));
		results.setStatus("0");
