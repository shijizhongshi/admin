									...
									<div class="grade-left" style="padding-right: 5%;">
										...
										<div style="width: 100%; height: 90px; clear: both;">
											<div class=" select-2" style="float: left;">
												<img src="/images/sjk-xl.png" /> <span>分类：</span> 
												<select ng-model="courseNofree.courseResourceType">
													<option ng-selected="courseNofree.courseResourceType=='基础课' " value="基础课">基础课</option>
													<option ng-selected="courseNofree.courseResourceType=='实践技能' " value="实践技能">实践技能</option>
													<option ng-selected="courseNofree.courseResourceType=='应试技巧' " value="应试技巧">应试技巧</option>
														<option ng-selected="courseNofree.courseResourceType=='冲刺课' " value="冲刺课">冲刺课</option>
				<option ng-selected="courseNofree.courseResourceType=='习题精讲' " value="习题精讲">习题精讲</option>
				<option ng-selected="courseNofree.courseResourceType=='包过套餐' " value="包过套餐">包过套餐</option>
													
												</select>
											</div>
											<div class=" select-2" style="float: right;">
												<img src="/images/sjk-xl.png" /> <span>课程用途：</span> 
												<select ng-model="courseNofree.courseUseDifference">
													<option ng-selected="courseNofree.courseUseDifference=='自用课程' " value="自用课程">自用课程</option>
				<option ng-selected="courseNofree.courseUseDifference=='部门共用' " value="部门共用"> 部门共用</option>
				<option ng-selected="courseNofree.courseUseDifference=='公司共用' " value="公司共用">公司共用</option>
				<option ng-selected="courseNofree.courseUseDifference=='他人共用' " value="他人共用">他人共用</option>
