...
<div class="manage">
    ...
    <img style="height:130px;" src="{{imgUrl}}"/></div>
        </div>
        <div  class="select-radio ">
		<ul><li>是否推荐</li>  
		<li><input type="radio" ng-model="news.isrecommend" ng-value="1"/> 是</li> 
		<li><input type="radio" ng-model="news.isrecommend" ng-value="0"/>否</li></ul>
		</div>
		<div  class="select-radio ">
		<ul><li>是否展示</li>  
		<li><input type="radio" ng-model="news.status" ng-value="0"/> 是</li> 
		<li><input type="radio" ng-model="news.status" ng-value="1"/>失效</li>
		</ul>
		</div>
</div>
					...
					<div class="end">
						<input name="git" type="submit" value="提交"
							ng-if="newsId==null" ng-click="newadd()"
