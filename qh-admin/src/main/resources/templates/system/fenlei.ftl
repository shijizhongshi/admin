		...
		<div class="details" style="width: 100%">
			...
			<div class="details-frame">
				<div class="details-frame-content" id="details-frame-content">
					<ul>
						<li ng-repeat="s in shopDrugCategory"
							ng-click="checkedShopcate(s)" ng-class="{'clicked':clicked==s}">
							{{s.categoryName}} <i ng-click="deletecate(s)"
							ng-show="selectdelete==s" class="glyphicon glyphicon-remove"
					...
					<div class="poop" id="add">
						<form id="myform">
							...
							<div class="template-add">
								...
								<div class="select-2">
									<span>分类名称</span> <input type="text" ng-model="name" />
						...
						<div class="end">
							<input name="git" type="submit" value="提交" ng-show="insert==1"
								ng-click="insertcatesub()" style="background: #5ED8A9;" /> <input
								name="git" type="submit" value="修改" ng-show="update==1"
								ng-click="updatesub()" style="background: #5ED8A9;" /> <input
